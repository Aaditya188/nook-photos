...
export const ICON: Record<string, string> = {
  ...
  storage: '<svg viewBox="0 0 24 24" fill="none"><rect x="4" y="12" width="4" height="8" rx="1" stroke="currentColor" stroke-width="1.8"/><rect x="10" y="7" width="4" height="13" rx="1" stroke="currentColor" stroke-width="1.8"/><rect x="16" y="4" width="4" height="16" rx="1" stroke="currentColor" stroke-width="1.8"/></svg>',
  recap: '<svg viewBox="0 0 24 24" fill="none"><path d="M12 3l1.9 4.8L19 9.2l-3.6 3.4.9 5-4.3-2.5L7.7 17.6l.9-5L5 9.2l5.1-1.4z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/></svg>',
  duplicate: '<svg viewBox="0 0 24 24" fill="none"><rect x="8.5" y="8.5" width="11" height="11" rx="2.5" stroke="currentColor" stroke-width="1.8"/><path d="M15.5 8.5V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v7.5a2 2 0 0 0 2 2h2.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  ...
  trips: '<svg viewBox="0 0 24 24" fill="none"><rect x="4" y="7.5" width="16" height="12" rx="2.5" stroke="currentColor" stroke-width="1.8"/><path d="M9 7.5V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1.5M8.5 11v5M15.5 11v5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
